...
### Always Remember and Take Consideration of the Following
    - Sail is always running as ./vendor/bin/sail up -d
    - NPM is always running and commands are run as ./vendor/bin/sail npm <command>
