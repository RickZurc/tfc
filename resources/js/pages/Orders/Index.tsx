...
export default function OrdersIndex() {
    ...
    const hasActiveFilters = searchQuery.trim() !== '' || statusFilter !== 'all' || dateFrom !== undefined || dateTo !== undefined;
                ...
                <Card className="mb-6">
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
                            ...
                            <DatePicker date={dateFrom} onDateChange={handleDateFromChange} placeholder="From date" disableFutureDates={true} />

                            <DatePicker date={dateTo} onDateChange={handleDateToChange} placeholder="To date" disableFutureDates={true} />
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center justify-between">
                            ...
                            {hasActiveFilters && <span className="text-sm text-muted-foreground">Showing filtered results</span>}
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-4">
                            {orders.data.length === 0 ? (
                                ...
                                orders.data.map((order) => (
                                    <Card key={order.id} className={`border-l-4 ${order.status === 'refunded' ? 'border-l-red-500' : 'border-l-blue-500'}`}>
                                        <CardContent className="p-4">
                                            <div className="flex items-center justify-between">
                                                    ...
                                                    <Dialog>
                                                        ...
                                                        <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-4xl">
                                                            <DialogHeader>
                                                                ...
                                                                <DialogDescription>Complete details for this sale transaction</DialogDescription>
                                                            </DialogHeader>
                                                            ...
                                                            {selectedOrder && (
                                                                <div className="space-y-6">
                                                                    ...
                                                                    {/* Items */}
                                                                    <div>
                                                                        <h4 className="mb-4 font-semibold">Items Purchased</h4>
                                                                        ...
                                                                        <div className="space-y-2">
                                                                            <div className="flex justify-between">
                                                                                ...
                                                                                <span>
                                                                                    $
                                                                                    {formatCurrency(
                                                                                        selectedOrder.total_amount + selectedOrder.discount_amount,
                                                                                    )}
                                                                                </span>
                                                                            </div>
                                                                                ...
                                                                                <>
                                                                                    ...
                                                                                    {selectedOrder.refunded_at && (
                                                                                        <div className="text-sm text-muted-foreground">
                                                                                            ...
                                                                                            {formatDate(selectedOrder.refunded_at)}
                                                                                        </div>
                                                                                    )}
                                                                                </>
                                                                            )}
            ...
            <Dialog open={showRefundModal} onOpenChange={setShowRefundModal}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>{refundOrder && `Process refund for order ${refundOrder.order_number}`}</DialogDescription>
                    </DialogHeader>
                        ...
                        <form onSubmit={handleRefundSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    required
                                />
                                <p className="text-xs text-muted-foreground">Maximum refund: ${formatCurrency(refundOrder.total_amount)}</p>
                            </div>
                            ...
                            <div className="flex gap-2 pt-4">
                                ...
                                <Button type="submit" disabled={isProcessingRefund || !refundAmount || !refundReason} className="flex-1">
